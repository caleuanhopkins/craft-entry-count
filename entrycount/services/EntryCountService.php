...
class EntryCountService extends BaseApplicationComponent
{
    ...
    public function getCount($entryId, $type)
    {
        ...
        if($type == 'Commerce_Product'){
            $entryCountRecord = EntryCountRecord::model()->findByAttributes(array('productId' => $entryId));
        }else{
    ...
    public function getEntries()
    {
        ...
        {
            if($entryCountRecord->entryId == null){
                $entryIds[] = $entryCountRecord->productId;
            }else{
    ...
    public function increment($entryId, $type)
    {
        ...
        else
        {
            ...
            if($type == 'product'){
                $entryCountRecord->setAttribute('productId', $entryId);
            }else{
